package ru.gothmog.mediafile.config.application;
...
@Configuration
@EnableWebMvc
@ComponentScan({"ru.gothmog.mediafile.*",
                "ru.gothmog.mediafile.config",
                "ru.gothmog.mediafile.controller",
                "ru.gothmog.mediafile.model",
                "ru.gothmog.mediafile.core"})
